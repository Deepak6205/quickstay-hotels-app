...
const RoomDetails = () => {
  ...
  //handle form to check avliblty & book the room
      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            availibility. You will get a comfortable two bedroom apartment has a
            true city feeling. The price quoted is for two guests, at guest slot
            please mark the number of guests to get the exect price of group.
            The guests will be allocated ground floor according to the
            availibility. You get the comfortable two two bedroom apartment that
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <button
            className="px-6 py-2.5 mt-4 rounded text-white
