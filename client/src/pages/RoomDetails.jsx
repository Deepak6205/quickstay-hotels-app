      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
              <div className="flex flex-col">
                <h1 className="text-3xl md:text-4xl font-playfair">Experience
                     luxury like never before</h1>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
            <p>Guests will be allocated on the ground floor according to the availibility.
                You will get a comfortable two bedroom apartment has a true city feeling.
                The price quoted is for two guests, at guest slot please mark the number
                of guests to get the exect price of group. The guests will be allocated
                ground floor according to the availibility. You get the comfortable two
        ...
        <div className="flex flex-col items-start gap-4">
            ...
            bg-primary hover:bg-primary-dull cursor-pointer">Contact Now</button>
        </div>
      </div>
    )
  );
